...
class Wechat::Api
  ...
  def batchtagging openid_list, tagid
    post 'tags/members/batchtagging', JSON.generate({ openid_list: openid_list, tagid: tagid })
  end

  def batchuntagging openid_list, tagid
    post 'tags/members/batchuntagging', JSON.generate({ openid_list: openid_list, tagid: tagid })
  end
